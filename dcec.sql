...
--
-- Servidor: localhost
-- Tiempo de generación: 15-07-2021 a las 07:08:19
...
INSERT INTO `servicios` (`id`, `nombre`, `imagen`, `altimg`) VALUES
(1, 'Medicina familiar', 'img/medicinageneral.jpg', 'medicina familiar'),
(2, 'Enfermedades musculo esqueléticas', 'img/musculoesqueleticas.jpg', 'Enfermedades musuculo esqueléticas | musculo-esqueléticas'),
(3, 'Enfermedades respiratorias', 'img/respiratorias.jpg', 'Enfermedades respiratorias'),
(4, 'Ansiedad y depresión', 'img/ansiedaddepresion.jpg', 'Ansiedad y depresión'),
(5, 'Control de embarazo', 'img/controlembarazo.jpg', 'Control de embarazo'),
(6, 'Diagnóstico y control de hipertensión', 'img/hipertension.jpg', 'Diagnóstico y control de hipertensión'),
(7, 'Diagnóstico y control de diabetes', 'img/diabetesmellitus.jpg', 'Diagnóstico y control de diabetes'),
(8, 'Atención del niño y adolescente', 'img/ninosadolescentes.jpg', 'Atención del niño y adolescente'),
(9, 'Atención del adulto mayor', 'img/adultomayor.jpg', 'Atención del adulto mayor');
